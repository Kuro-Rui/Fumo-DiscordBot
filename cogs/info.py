...
class Info(commands.Cog):
    ...
    def __init__(self, bot: FumoBot):
        super().__init__(bot, discord.PartialEmoji(name="KokoroThink", id=1174520928768638996))
    ...
    async def slash_help(
        self, interaction: discord.Interaction, category_or_command: Optional[str]
    ):
    ...
    @slash_help.autocomplete("category_or_command")
    ...
    @commands.hybrid_command(aliases=["about", "info"])
    ...
    async def uptime(self, ctx: commands.Context):
        ...
        timedelta = datetime.datetime.utcnow() - self.bot.uptime
        uptime = humanize.precisedelta(timedelta)
